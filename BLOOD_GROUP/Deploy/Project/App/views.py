...
def Deploy_8(request): 
    ...
    if request.method == "POST":
        ...
        models = keras.models.load_model('C:/Users/Shirisha.N/Downloads/BLOOD_GROUP/BLOOD_GROUP/Deploy/Project/App/keras_model.h5')
        data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)
        image = Image.open("C:/Users/Shirisha.N/Downloads/BLOOD_GROUP/BLOOD_GROUP/Deploy/Project/" + str(result1)).convert("RGB")
        size = (224, 224)
        ...
        a = (classes[idd])
        if a == 'A-':
            a = 'FOUND THIS IMAGE IS A-'
        elif a == 'A+':
            a = 'FOUND THIS IMAGE IS A+'
        elif a == 'AB-':
            a = 'FOUND THIS IMAGE IS AB-'
        elif a == 'AB+':
            a = 'FOUND THIS IMAGE IS AB+'
        elif a == 'B-':
            a = 'FOUND THIS IMAGE IS B-'
        elif a == 'B+':
            a = 'FOUND THIS IMAGE IS B+'
        elif a == 'O-':
            a = 'FOUND THIS IMAGE IS O-'
        elif a == 'O+':
            a = 'FOUND THIS IMAGE IS O+'
